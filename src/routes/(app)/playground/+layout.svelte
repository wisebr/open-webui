			...
			<div class=" flex w-full">
				...
				>
					<a
						...
						href="{WEBUI_ROUTE_BASE_URL}/playground">{$i18n.t('Chat')}</a
					>
					...
					<!-- <a
						class="min-w-fit rounded-full p-1.5 {$page.url.pathname.includes('/playground/notes')
							? ''
							: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition"
						href="{WEBUI_ROUTE_BASE_URL}/playground/notes">{$i18n.t('Notes')}</a
					> -->
					...
					<a
						class="min-w-fit rounded-full p-1.5 {$page.url.pathname.includes(
							...
							? ''
							: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition"
						href="{WEBUI_ROUTE_BASE_URL}/playground/completions">{$i18n.t('Completions')}</a
					>
				</div>
			</div>
		</div>
