				...
				{:else}
					<div
						class=" {rmsLevel * 100 > 4
							...
							?.profile_image_url ?? `${WEBUI_ROUTE_BASE_URL}/static/favicon.png`) !== `${WEBUI_ROUTE_BASE_URL}/static/favicon.png`
							? ' bg-cover bg-center bg-no-repeat'
							: 'bg-black dark:bg-white'}  bg-black dark:bg-white"
						style={(model?.info?.meta?.profile_image_url ?? `${WEBUI_ROUTE_BASE_URL}/static/favicon.png`) !==
